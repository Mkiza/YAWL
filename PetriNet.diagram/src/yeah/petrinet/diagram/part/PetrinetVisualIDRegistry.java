...
public class PetrinetVisualIDRegistry {
	...
	* @generated
	*/
	private static final String DEBUG_KEY = "PetriNet.diagram/debug/visualID"; //$NON-NLS-1$
	...
	*/
	public static int getVisualID(View view) {
		...
		return yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.getVisualID(view.getType());
	}
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.getModelID(containerView);
		if (!PetrinetEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (PetrinetEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.getVisualID(containerView);
		} else {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getVisualID(View view) {
			return yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.getVisualID(view);
		}
		...
		*/
		...
		public String getModelID(View view) {
			return yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return yeah.petrinet.diagram.part.PetrinetVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
