...
public class TransitionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PetrinetParserProvider.getParser(PetrinetElementTypes.Transition_2002, getParserElement(),
					PetrinetVisualIDRegistry
							.getType(yeah.petrinet.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
