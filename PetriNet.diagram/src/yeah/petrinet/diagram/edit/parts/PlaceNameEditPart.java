...
import yeah.petrinet.diagram.edit.policies.PetrinetTextSelectionEditPolicy;
...
public class PlaceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PetrinetParserProvider.getParser(PetrinetElementTypes.Place_2003, getParserElement(),
					PetrinetVisualIDRegistry.getType(yeah.petrinet.diagram.edit.parts.PlaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
