...
import yeah.petrinet.diagram.edit.commands.PlaceCreateCommand;
import yeah.petrinet.diagram.edit.commands.TransitionCreateCommand;
...
public class PetrinetItemSemanticEditPolicy extends PetrinetBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PetrinetElementTypes.Place_2003 == req.getElementType()) {
