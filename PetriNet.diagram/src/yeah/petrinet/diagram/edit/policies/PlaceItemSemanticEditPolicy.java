...
import yeah.petrinet.diagram.edit.commands.ArcCreateCommand;
import yeah.petrinet.diagram.edit.commands.ArcReorientCommand;
import yeah.petrinet.diagram.edit.commands.TokenCreateCommand;
...
public class PlaceItemSemanticEditPolicy extends PetrinetBaseItemSemanticEditPolicy {
	...
	*/
	public PlaceItemSemanticEditPolicy() {
		super(PetrinetElementTypes.Place_2003);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (PetrinetElementTypes.Arc_4010 == req.getElementType()) {
