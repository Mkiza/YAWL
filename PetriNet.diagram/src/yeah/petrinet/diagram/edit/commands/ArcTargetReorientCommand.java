 ...
 * @generated
 */
public class ArcTargetReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ArcTargetReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canExistArcTarget_4003(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canExistArcTarget_4003(getOldSource(),
				getNewTarget());
	}
