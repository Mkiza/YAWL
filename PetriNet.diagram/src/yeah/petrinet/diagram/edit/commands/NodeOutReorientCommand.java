 ...
 * @generated
 */
public class NodeOutReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public NodeOutReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canExistNodeOut_4005(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canExistNodeOut_4005(getOldSource(),
				getNewTarget());
	}
