 ...
 * @generated
 */
public class ArcSourceCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ArcSourceCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return PetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canCreateArcSource_4006(getSource(),
				getTarget());
	}
