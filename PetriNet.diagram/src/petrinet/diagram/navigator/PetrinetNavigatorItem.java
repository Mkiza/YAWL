		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof petrinet.diagram.navigator.PetrinetNavigatorItem
					...
					return ((petrinet.diagram.navigator.PetrinetNavigatorItem) adaptableObject).getView();
				}
				return null;
			}
	...
	public boolean equals(Object obj) {
		if (obj instanceof petrinet.diagram.navigator.PetrinetNavigatorItem) {
			return EcoreUtil.getURI(getView())
					.equals(EcoreUtil.getURI(((petrinet.diagram.navigator.PetrinetNavigatorItem) obj).getView()));
		}
