...
public class PetrinetVisualIDRegistry {
	...
	*/
	public static int getVisualID(View view) {
		...
		return petrinet.diagram.part.PetrinetVisualIDRegistry.getVisualID(view.getType());
	}
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = petrinet.diagram.part.PetrinetVisualIDRegistry.getModelID(containerView);
		if (!PetrinetEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (PetrinetEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = petrinet.diagram.part.PetrinetVisualIDRegistry.getVisualID(containerView);
		} else {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public String getModelID(View view) {
			return petrinet.diagram.part.PetrinetVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return petrinet.diagram.part.PetrinetVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return petrinet.diagram.part.PetrinetVisualIDRegistry.checkNodeVisualID(containerView, domainElement,
					candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return petrinet.diagram.part.PetrinetVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return petrinet.diagram.part.PetrinetVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
