/**
 */
package yeah.petrinet.provider;
...
/**
 * This is the item provider adapter for a {@link yeah.petrinet.petrinet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class petrinetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_petrinet_nume_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_petrinet_nume_feature", "_UI_petrinet_type"),
				 PetrinetPackage.Literals.PETRINET__NUME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((petrinet)object).getNume();
