...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 * @see yeah.petrinet.PetrinetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getpetrinet_Nume() {
	...
	public void createPackageContents() {
		...
		createEAttribute(petrinetEClass, PETRINET__NUME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getpetrinet_Nume(), ecorePackage.getEString(), "nume", null, 0, 1, petrinet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArc_Source(), this.getNode(), this.getNode_Out(), "source", null, 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_Target(), this.getNode(), this.getNode_In(), "target", null, 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
